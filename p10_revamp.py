...
# In this implementation we are only required to find primes up to 2000000
#  and uses addition

# - More concise Sieve design
...
# Operating Sieve of Eratosthenes 
def findp():
    
    upper_bound = 2000000
    
    # Cycles through all odd numbers as
    for prime_candidate in range(3,upper_bound,2):
        v_true=0
